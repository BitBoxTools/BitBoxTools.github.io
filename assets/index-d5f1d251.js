import{v as B,x as re,y as se,z as ie,r as T,D as r,I as z,J as oe,F as S,G as ce,bJ as de,S as L,E as le,bK as _e}from"./index-c59470c7.js";import{F as q,M as me,c as fe,U as ue,S as U,P as V,d as W,e as ge,I as Q,T as P,n as F,h as he}from"./save_excel-f0dd4cf4.js";import{C as pe,a as ye,R as Ce,d as G}from"./deleteData-95be7c6c.js";import{a as be}from"./index-b0fea559.js";import{m as xe}from"./index-0d6139dc.js";async function J(d,s,c){const i=await B.post(d,s,{headers:c});let n=[];const a={"StarkGate: ETH":1800,"StarkGate: USDT":1,"StarkGate: USDC":1,"StarkGate: DAI":1,"StarkGate: WBTC":29500};return i.data.data.erc20TransferEvents.edges.forEach(o=>{const{transaction_hash:m,from_address:f,transfer_amount_display:_,transfer_from_address:u,transfer_to_address:x,from_erc20_identifier:w,main_call:D,timestamp:A,__typename:N}=o.node;n.push({transaction_hash:m,from_address:f,transfer_amount_display:_,transfer_from_address:u,transfer_to_address:x,from_erc20_identifier:w,timestamp:A,main_call:D,__typename:N,total_value:a.hasOwnProperty(w)?_*a[w]:0})}),{transfers:n,hasNextPage:i.data.data.erc20TransferEvents.pageInfo.hasNextPage,endCursor:i.data.data.erc20TransferEvents.pageInfo.endCursor}}async function Te(d){const s="https://starkscan.stellate.sh/",c={authority:"starkscan.stellate.sh","accept-language":"zh-CN,zh;q=0.9,en;q=0.8,en-GB;q=0.7,en-US;q=0.6"},i={query:`query ERC20TransferEventsTableQuery(
  $first: Int!
  $after: String
...
`,variables:{first:100,after:null,input:{initiator_address:d,sort_by:"timestamp",order_by:"desc",min_block_number:null,max_block_number:null,min_timestamp:null,max_timestamp:null}}};let n=[],a=await M(s,i,c);for(n.push(...a.transactions);a.hasNextPage;)i.variables.after=a.endCursor,a=await M(s,i,c),n.push(...a.transactions);const o=await Te(d);return o.forEach(m=>{n.forEach(f=>{m.transaction_hash===f.transaction_hash&&f.transfers.push(m)})}),{transfers:o,transactions:n}}const K=d=>{const s=new Date(d)*1e3,c=(new Date().getTime()-new Date(s).getTime())/1e3;if(c<60)return Math.round(c)+" 秒前";const i=c/60;if(i<60)return Math.round(i)+" 分前";const n=i/60;if(n<24)return Math.round(n)+" 时前";const a=n/24;return Math.round(a)+" 天前"},ve=async d=>{try{if(!d)return{tx:0,lastTime:"无交易",fee:0};let s=0;d.forEach(a=>{s+=parseFloat(a.actual_fee_display)});const c=d[0].nonce,i=d[0].timestamp,n=K(i)||"无交易";return{tx:c,lastTime:n,fee:Number(s).toFixed(3)}}catch{return{tx:"-",lastTime:"-",fee:"-"}}};async function we(d){try{const s="https://starkscan.stellate.sh/",c={query:`query ERC20BalancesByOwnerAddressTableQuery(
...
`,variables:{input:{contract_address:d}}},i={authority:"starkscan.stellate.sh",accept:"application/json","accept-language":"zh-CN,zh;q=0.9,en;q=0.8,en-GB;q=0.7,en-US;q=0.6","content-type":"application/json"},n=await B.post(s,c,{headers:i}),a=K(n.data.data.contract.deployed_at_timestamp),o=n.data.data.contract.starknet_id?n.data.data.contract.starknet_id.domain:"无";return{deployedTime:a,starkId:o}}function De(d){try{let s=0;return d.forEach(c=>{const i=c.transfers.sort((a,o)=>parseInt(o.total_value)-parseInt(a.total_value));if(i.length===0)return;const n=parseFloat(i[0].total_value);s+=n}),{Vol:s.toFixed(3)}}catch(s){return console.log(s),{Vol:"-"}}}const H=async d=>{let s;try{await re(se);const c=await ke(d),i=c.transactions,n=c.transfers,a=Fe(d,n),{tx:o,lastTime:m,fee:f}=await ve(i),_=await we(d),u=Ee(n),x=await je(d),w=De(i);return s={accountInfo:x,balance:_,tx:o,lastTime:m,fee:f,activity:a,bridge:u,...w,result:"success"},await ie("starkTransactions",{address:d,data:JSON.stringify(i)}),s}catch(c){return s={result:"error",reason:c.message},s}};const{TextArea:Ae}=Q,{Content:Pe}=be,$e=()=>{const[d,s]=T.useState(!1),[c,i]=T.useState(!1),[n,a]=T.useState([]),[o]=q.useForm(),[m,f]=T.useState(!1),[_,u]=T.useState([]),[x,w]=T.useState(!1);let D=n.length+1;const[A,N]=T.useState(!1);T.useEffect(()=>{w(!0);const e=localStorage.getItem("stark_addresses");setTimeout(()=>{w(!1)},500),e&&a(JSON.parse(e)),N(!0)},[]),T.useEffect(()=>{A&&localStorage.setItem("stark_addresses",JSON.stringify(n))},[n,A]);const Y=[{title:"#",key:"index",align:"center",render:(e,t,y)=>y+1},{title:"备注",dataIndex:"name",key:"name",align:"center",className:"name",render:(e,t)=>t.key===ne?r.jsx(Q,{placeholder:"请输入备注",defaultValue:e,onPressEnter:g=>{t.name=g.target.value,a([...n]),localStorage.setItem("stark_addresses",JSON.stringify(n)),$(null)}}):r.jsxs(r.Fragment,{children:[r.jsx(P,{color:"blue",children:e}),r.jsx(S,{shape:"circle",icon:r.jsx(ce,{}),size:"small",onClick:()=>$(t.key)})]})},{title:"钱包地址",dataIndex:"address",key:"address",align:"center",className:"address",render:(e,t)=>{const y=()=>{_e(e),xe.success("地址已复制")};return e?r.jsxs(r.Fragment,{children:[e.slice(0,4),"...",e.slice(-4),r.jsx(S,{type:"text",icon:r.jsx(de,{}),onClick:y,style:{marginLeft:8}})]}):r.jsx(z,{})}},{title:"StarkId",dataIndex:["accountInfo","starkId"],key:"starkId",align:"center",render:(e,t)=>e},{title:"StarkNet",className:"zksync2",children:[{title:"ETH",dataIndex:["balance","ETH"],key:"stark_eth_balance",align:"center",render:(e,t)=>e},{title:"USDC",dataIndex:["balance","USDC"],key:"stark_usdc_balance",align:"center",render:(e,t)=>e},{title:"USDT",dataIndex:["balance","USDT"],key:"stark_usdt_balance",align:"center",render:(e,t)=>e},{title:"DAI",dataIndex:["balance","DAI"],key:"stark_dai_balance",align:"center",render:(e,t)=>e},{title:"WBTC",dataIndex:["balance","WBTC"],key:"stark_wbtc_balance",align:"center",render:(e,t)=>e},{title:"Tx",dataIndex:"tx",key:"stark_tx_amount",align:"center",render:(e,t)=>e,sorter:(e,t)=>e.tx-t.tx},{title:"最后交易",dataIndex:"lastTime",key:"stark_latest_tx",align:"center",render:(e,t)=>r.jsx("a",{href:`https://voyager.online/contract/${t.address}`,target:"_blank",children:e})},{title:"官方桥Tx",className:"stark_cross_tx",children:[{title:"L1->L2",dataIndex:["bridge","DepositTx"],align:"center",render:(e,t)=>e},{title:"L2->L1",dataIndex:["bridge","WithdrawTx"],align:"center",render:(e,t)=>e}]},{title:"官方桥金额(U)",className:"stark_cross_amount",children:[{title:"L1->L2",dataIndex:["bridge","DepositVolume"],align:"center",render:(e,t)=>e},{title:"L2->L1",dataIndex:["bridge","WithdrawVolume"],align:"center",render:(e,t)=>e}]},{title:"活跃统计",className:"stark_activity",children:[{title:"天",dataIndex:["activity","dayActivity"],align:"center",render:(e,t)=>e},{title:"周",dataIndex:["activity","weekActivity"],align:"center",render:(e,t)=>e},{title:"月",dataIndex:["activity","monthActivity"],align:"center",render:(e,t)=>e},{title:"合约",dataIndex:["activity","contractActivity"],align:"center",render:(e,t)=>e},{title:"Vol(U)",dataIndex:"Vol",align:"center",render:(e,t)=>e,sorter:(e,t)=>e.Vol-t.Vol},{title:"fee(E)",dataIndex:"fee",align:"center",render:(e,t)=>e,sorter:(e,t)=>e.fee-t.fee}]},{title:"状态",key:"result",align:"center",render:(e,t)=>r.jsxs(L,{children:[t.result==="success"?r.jsx(P,{icon:r.jsx(pe,{}),color:"success",children:"成功"}):null,t.result==="error"?r.jsx(le,{title:t.reason,children:r.jsx(P,{icon:r.jsx(ye,{}),color:"error",children:"失败 "})}):null,t.result==="pending"?r.jsx(P,{icon:r.jsx(U,{spin:!0}),color:"processing",children:"获取中 "}):null]})},{title:"操作",key:"action",align:"center",render:(e,t)=>r.jsxs(L,{children:[r.jsx(V,{title:"确认删除？",onConfirm:async()=>{await X(t.address)},children:r.jsx(S,{icon:r.jsx(W,{})})}),r.jsx(S,{icon:r.jsx(Ce,{}),onClick:()=>{R(t.key)}})]})}]}],X=async e=>{a(n.filter(t=>t.address!==e)),localStorage.setItem("stark_addresses",JSON.stringify(n.filter(t=>t.address!==e))),await G("starkTransactions",[e])},Z=async()=>{try{i(!0),s(!1);const t=(await o.validateFields()).addresses.split(`
`),y=5;let g=0,h=[];const k=()=>{for(;h.length>0&&g<y;){const l=h.shift();g+=1,l().finally(()=>{g-=1,k()})}};for(let l of t){if(l=l.trim(),l.length!==66&&l.length!==64){F.error({message:"错误",description:"请输入正确的stark地址(64位)",duration:1});continue}l.startsWith("0x")||(l="0x"+l);const v=()=>new Promise(async(E,O)=>{try{a(I=>{const C=[...I];if(C.findIndex(b=>b.address===l)===-1){const b={key:D.toString(),address:l,result:"pending"};D++,C.push(b)}return C});const j=await H(l);a(I=>{const C=[...I],p=C.findIndex(b=>b.address===l);return p!==-1&&(C[p]={...C[p],...j}),C}),E()}catch(j){O(j)}});h.push(v)}for(k();g>0||h.length>0;)await new Promise(l=>setTimeout(l,100));F.success({message:"成功",description:"批量添加完成",duration:1})}catch(e){F.error({message:"错误",description:e.message,duration:1})}finally{o.resetFields(),u([]),i(!1)}},R=async e=>{const t=e?[e]:_;if(!t.length){F.error({message:"错误",description:"请先选择要刷新的地址",duration:1});return}f(!0);try{let g=0,h=[];const k=()=>{for(;h.length>0&&g<5;){const l=h.shift();g+=1,l().finally(()=>{g-=1,k()})}};for(let l of t){const v=n.findIndex(E=>E.key===l);if(v!==-1){const E=()=>new Promise(async(O,j)=>{try{a(C=>{const p=[...C];for(let b in p[v])b!=="address"&&b!=="name"&&b!=="key"&&(b==="result"?p[v][b]="pending":p[v][b]=null);return p});const I=await H(n[v].address);a(C=>{const p=[...C];return p[v]={...p[v],...I},localStorage.setItem("stark_addresses",JSON.stringify(p)),p}),O()}catch(I){j(I)}});h.push(E)}}for(k();g>0||h.length>0;)await new Promise(l=>setTimeout(l,100));F.success({message:"完成",description:"刷新地址数据完成",duration:1})}catch(y){F.error({message:"错误",description:y.message,duration:1})}finally{f(!1),e||u([])}},ee=async()=>{if(!_.length){F.error({message:"错误",description:"请先选择要删除的地址",duration:1});return}const e=n.filter(t=>_.includes(t.key)).map(t=>t.address);await G("starkTransactions",e),a(n.filter(t=>!_.includes(t.key))),localStorage.setItem("stark_addresses",JSON.stringify(n.filter(t=>!_.includes(t.key)))),u([])},te=()=>{he(n,"starkInfo")},[ne,$]=T.useState(null),ae={selectedRowKeys:_,onChange:e=>{u(e)}};return r.jsx("div",{children:r.jsxs(Pe,{children:[r.jsx(me,{title:"批量添加地址",open:d,onOk:Z,onCancel:()=>{s(!1),o.resetFields()},okText:"添加地址",cancelText:"取消",width:800,children:r.jsx(q,{form:o,layout:"vertical",children:r.jsx(q.Item,{label:"地址",name:"addresses",rules:[{required:!0,validator:(e,t)=>{const y=t.split(`
`);let g=[];for(let h=0;h<y.length;h++){let k=y[h].trim();(!k.startsWith("0x")||k.length!==66&&k.length!==64)&&g.push(h+1)}return g.length?Promise.reject(`行 ${g.join(", ")} 的地址格式错误，请输入正确的stark地址(64位)`):Promise.resolve()}}],children:r.jsx(Ae,{placeholder:"请输入地址，每行一个",style:{width:"100%",height:"300px",resize:"none"}})})})}),r.jsx("div",{style:{marginBottom:"50px"},children:r.jsx(z,{spinning:x,size:"large",children:r.jsx(fe,{rowSelection:ae,dataSource:n,pagination:!1,bordered:!0,style:{marginBottom:"20px"},size:"small",columns:Y})})}),r.jsx("div",{className:"stark_footer",children:r.jsx(oe,{size:"small",style:{width:"100%"},children:r.jsxs("div",{style:{width:"100%",display:"flex",justifyContent:"space-between"},children:[r.jsx(S,{type:"primary",onClick:()=>{s(!0)},size:"large",style:{width:"25%"},icon:r.jsx(ue,{}),loading:c,children:c?"添加中...":"添加地址"}),r.jsx(S,{type:"primary",onClick:()=>R(),loading:m,size:"large",style:{width:"25%"},icon:r.jsx(U,{}),children:"刷新选中地址"}),r.jsx(V,{title:"确认删除"+_.length+"个地址？",onConfirm:async()=>{await ee()},children:r.jsx(S,{type:"primary",danger:!0,size:"large",style:{width:"25%"},icon:r.jsx(W,{}),children:"删除选中地址"})}),r.jsx(S,{type:"primary",icon:r.jsx(ge,{}),size:"large",style:{width:"8%"},onClick:te})]})})})]})})};export{$e as default};
