import{r as y,A as Q,f as O,s as P,x as s,S as L,D as se,B as S,E as ie,bI as oe,z as U,y as ce,bJ as le}from"./index-1b71864e.js";import{F as q,M as de,c as _e,U as me,S as V,P as W,d as M,e as fe,I as K,T as D,n as I,h as ue}from"./save_excel-d7bd70c0.js";import{a as ge}from"./index-d1d1b780.js";import{m as he}from"./index-f78eb762.js";import{R as pe}from"./ReloadOutlined-dceb9a5e.js";import"./index-58ff3423.js";var ye={icon:{tag:"svg",attrs:{viewBox:"64 64 896 896",focusable:"false"},children:[{tag:"path",attrs:{d:"M699 353h-46.9c-10.2 0-19.9 4.9-25.9 13.3L469 584.3l-71.2-98.8c-6-8.3-15.6-13.3-25.9-13.3H325c-6.5 0-10.3 7.4-6.5 12.7l124.6 172.8a31.8 31.8 0 0051.7 0l210.6-292c3.9-5.3.1-12.7-6.4-12.7z"}},{tag:"path",attrs:{d:"M512 64C264.6 64 64 264.6 64 512s200.6 448 448 448 448-200.6 448-448S759.4 64 512 64zm0 820c-205.4 0-372-166.6-372-372s166.6-372 372-372 372 166.6 372 372-166.6 372-372 372z"}}]},name:"check-circle",theme:"outlined"};const Ce=ye;var Y=function(a,c){return y.createElement(Q,O(O({},a),{},{ref:c,icon:Ce}))};Y.displayName="CheckCircleOutlined";const be=y.forwardRef(Y);var xe={icon:{tag:"svg",attrs:{viewBox:"64 64 896 896",focusable:"false"},children:[{tag:"path",attrs:{d:"M685.4 354.8c0-4.4-3.6-8-8-8l-66 .3L512 465.6l-99.3-118.4-66.1-.3c-4.4 0-8 3.5-8 8 0 1.9.7 3.7 1.9 5.2l130.1 155L340.5 670a8.32 8.32 0 00-1.9 5.2c0 4.4 3.6 8 8 8l66.1-.3L512 564.4l99.3 118.4 66 .3c4.4 0 8-3.5 8-8 0-1.9-.7-3.7-1.9-5.2L553.5 515l130.1-155c1.2-1.4 1.8-3.3 1.8-5.2z"}},{tag:"path",attrs:{d:"M512 65C264.6 65 64 265.6 64 513s200.6 448 448 448 448-200.6 448-448S759.4 65 512 65zm0 820c-205.4 0-372-166.6-372-372s166.6-372 372-372 372 166.6 372 372-166.6 372-372 372z"}}]},name:"close-circle",theme:"outlined"};const ke=xe;var X=function(a,c){return y.createElement(Q,O(O({},a),{},{ref:c,icon:ke}))};X.displayName="CloseCircleOutlined";const Te=y.forwardRef(X);async function G(o,a,c){const i=await P.post(o,a,{headers:c});let t=[];const n={"StarkGate: ETH":1800,"StarkGate: USDT":1,"StarkGate: USDC":1,"StarkGate: DAI":1,"StarkGate: WBTC":29500};return i.data.data.erc20TransferEvents.edges.forEach(l=>{const{transaction_hash:m,from_address:f,transfer_amount_display:d,transfer_from_address:u,transfer_to_address:k,from_erc20_identifier:F,main_call:A,timestamp:B,__typename:N}=l.node;t.push({transaction_hash:m,from_address:f,transfer_amount_display:d,transfer_from_address:u,transfer_to_address:k,from_erc20_identifier:F,timestamp:B,main_call:A,__typename:N,total_value:n.hasOwnProperty(F)?d*n[F]:0})}),{transfers:t,hasNextPage:i.data.data.erc20TransferEvents.pageInfo.hasNextPage,endCursor:i.data.data.erc20TransferEvents.pageInfo.endCursor}}async function ve(o){const a="https://starkscan.stellate.sh/",c={authority:"starkscan.stellate.sh","accept-language":"zh-CN,zh;q=0.9,en;q=0.8,en-GB;q=0.7,en-US;q=0.6"},i={query:`query ERC20TransferEventsTableQuery(
  $first: Int!
  $after: String
...
`,variables:{first:30,after:null,input:{initiator_address:o,sort_by:"timestamp",order_by:"desc",min_block_number:null,max_block_number:null,min_timestamp:null,max_timestamp:null}}};let t=[],n=await J(a,i,c);for(t.push(...n.transactions);n.hasNextPage;)i.variables.after=n.endCursor,n=await J(a,i,c),t.push(...n.transactions);const l=await ve(o);l.forEach(f=>{t.forEach(d=>{f.transaction_hash===d.transaction_hash&&d.transfers.push(f)})});const m=JSON.parse(localStorage.getItem("stark_transactions"));if(m===null)return localStorage.setItem("stark_transactions",JSON.stringify([{address:o,transactions:t}])),t;{const f=m.findIndex(d=>d.address===o);f===-1?m.push({address:o,transactions:t}):m[f].transactions=t,localStorage.setItem("stark_transactions",JSON.stringify(m))}return{transfers:l,transactions:t}}const Z=o=>{const a=new Date(o)*1e3,c=(new Date().getTime()-new Date(a).getTime())/1e3;if(c<60)return Math.round(c)+" 秒前";const i=c/60;if(i<60)return Math.round(i)+" 分前";const t=i/60;if(t<24)return Math.round(t)+" 时前";const n=t/24;return Math.round(n)+" 天前"},we=async o=>{try{if(!o)return{tx:0,lastTime:"无交易",fee:0};let a=0;o.forEach(n=>{a+=parseFloat(n.actual_fee_display)});const c=o[0].nonce,i=o[0].timestamp,t=Z(i)||"无交易";return{tx:c,lastTime:t,fee:Number(a).toFixed(3)}}catch{return{tx:"-",lastTime:"-",fee:"-"}}};async function Ie(o){try{const a="https://starkscan.stellate.sh/",c={query:`query ERC20BalancesByOwnerAddressTableQuery(
