...
`,variables:{input:{contract_address:d}}},i={authority:"starkscan.stellate.sh",accept:"application/json","accept-language":"zh-CN,zh;q=0.9,en;q=0.8,en-GB;q=0.7,en-US;q=0.6","content-type":"application/json"},t=await P.post(s,c,{headers:i}),n=Q(t.data.data.contract.deployed_at_timestamp),o=t.data.data.contract.starknet_id?t.data.data.contract.starknet_id.domain:"无";return{deployedTime:n,starkId:o}}function Fe(d){try{let s=0;return d.forEach(c=>{const i=c.transfers.sort((n,o)=>parseInt(o.total_value)-parseInt(n.total_value));if(i.length===0)return;const t=parseFloat(i[0].total_value);s+=t}),{Vol:s.toFixed(3)}}catch(s){return console.log(s),{Vol:"-"}}}const H=async d=>{let s;try{await _e(me);const c=await be(d),i=c.transactions,t=c.transfers,n=we(d,t),{tx:o,lastTime:m,fee:f}=await xe(i),_=await ke(d),u=Se(t),x=await Ie(d),w=Fe(i);return s={accountInfo:x,balance:_,tx:o,lastTime:m,fee:f,activity:n,bridge:u,...w,result:"success"},await fe("starkTransactions",{address:d,data:JSON.stringify(i)}),s}catch(c){return s={result:"error",reason:c.message},s}};const{TextArea:Ee}=J,{Content:je}=ue,Re=()=>{const[d,s]=k.useState(!1),[c,i]=k.useState(!1),[t,n]=k.useState([]),[o]=q.useForm(),[m,f]=k.useState(!1),[_,u]=k.useState([]),[x,w]=k.useState(!1);let D=t.length+1;k.useEffect(()=>{w(!0);const e=localStorage.getItem("stark_addresses");setTimeout(()=>{w(!1)},500),e&&n(JSON.parse(e))},[]),k.useEffect(()=>{localStorage.setItem("stark_addresses",JSON.stringify(t))},[t]),k.useEffect(()=>{localStorage.getItem("stark_transactions")&&localStorage.removeItem("stark_transactions")},[]);const B=[{title:"#",key:"index",align:"center",render:(e,a,y)=>y+1},{title:"备注",dataIndex:"name",key:"name",align:"center",className:"name",render:(e,a)=>a.key===Z?r.jsx(J,{placeholder:"请输入备注",defaultValue:e,onPressEnter:g=>{a.name=g.target.value,n([...t]),localStorage.setItem("stark_addresses",JSON.stringify(t)),$(null)}}):r.jsxs(r.Fragment,{children:[r.jsx(A,{color:"blue",children:e}),r.jsx(S,{shape:"circle",icon:r.jsx(ne,{}),size:"small",onClick:()=>$(a.key)})]})},{title:"钱包地址",dataIndex:"address",key:"address",align:"center",className:"address",render:(e,a)=>{const y=()=>{se(e),ge.success("地址已复制")};return e?r.jsxs(r.Fragment,{children:[e.slice(0,4),"...",e.slice(-4),r.jsx(S,{type:"text",icon:r.jsx(ae,{}),onClick:y,style:{marginLeft:8}})]}):r.jsx(z,{})}},{title:"StarkId",dataIndex:["accountInfo","starkId"],key:"starkId",align:"center",render:(e,a)=>e},{title:"StarkNet",className:"zksync2",children:[{title:"ETH",dataIndex:["balance","ETH"],key:"stark_eth_balance",align:"center",render:(e,a)=>e},{title:"USDC",dataIndex:["balance","USDC"],key:"stark_usdc_balance",align:"center",render:(e,a)=>e},{title:"USDT",dataIndex:["balance","USDT"],key:"stark_usdt_balance",align:"center",render:(e,a)=>e},{title:"DAI",dataIndex:["balance","DAI"],key:"stark_dai_balance",align:"center",render:(e,a)=>e},{title:"WBTC",dataIndex:["balance","WBTC"],key:"stark_wbtc_balance",align:"center",render:(e,a)=>e},{title:"Tx",dataIndex:"tx",key:"stark_tx_amount",align:"center",render:(e,a)=>e,sorter:(e,a)=>e.tx-a.tx},{title:"最后交易",dataIndex:"lastTime",key:"stark_latest_tx",align:"center",render:(e,a)=>r.jsx("a",{href:`https://voyager.online/contract/${a.address}`,target:"_blank",children:e})},{title:"官方桥Tx",className:"stark_cross_tx",children:[{title:"L1->L2",dataIndex:["bridge","DepositTx"],align:"center",render:(e,a)=>e},{title:"L2->L1",dataIndex:["bridge","WithdrawTx"],align:"center",render:(e,a)=>e}]},{title:"官方桥金额(U)",className:"stark_cross_amount",children:[{title:"L1->L2",dataIndex:["bridge","DepositVolume"],align:"center",render:(e,a)=>e},{title:"L2->L1",dataIndex:["bridge","WithdrawVolume"],align:"center",render:(e,a)=>e}]},{title:"活跃统计",className:"stark_activity",children:[{title:"天",dataIndex:["activity","dayActivity"],align:"center",render:(e,a)=>e},{title:"周",dataIndex:["activity","weekActivity"],align:"center",render:(e,a)=>e},{title:"月",dataIndex:["activity","monthActivity"],align:"center",render:(e,a)=>e},{title:"合约",dataIndex:["activity","contractActivity"],align:"center",render:(e,a)=>e},{title:"Vol(U)",dataIndex:"Vol",align:"center",render:(e,a)=>e,sorter:(e,a)=>e.Vol-a.Vol},{title:"fee(E)",dataIndex:"fee",align:"center",render:(e,a)=>e,sorter:(e,a)=>e.fee-a.fee}]},{title:"状态",key:"result",align:"center",render:(e,a)=>r.jsxs(L,{children:[a.result==="success"?r.jsx(A,{icon:r.jsx(he,{}),color:"success",children:"成功"}):null,a.result==="error"?r.jsx(re,{title:a.reason,children:r.jsx(A,{icon:r.jsx(pe,{}),color:"error",children:"失败 "})}):null,a.result==="pending"?r.jsx(A,{icon:r.jsx(U,{spin:!0}),color:"processing",children:"获取中 "}):null]})},{title:"操作",key:"action",align:"center",render:(e,a)=>r.jsxs(L,{children:[r.jsx(V,{title:"确认删除？",onConfirm:()=>N(a.key),children:r.jsx(S,{icon:r.jsx(W,{})})}),r.jsx(S,{icon:r.jsx(ye,{}),onClick:()=>{R(a.key)}})]})}]}],N=e=>{n(t.filter(a=>a.key!==e)),localStorage.setItem("stark_addresses",JSON.stringify(t.filter(a=>a.key!==e)))},K=async()=>{try{i(!0),s(!1);const a=(await o.validateFields()).addresses.split(`
`),y=5;let g=0,h=[];const T=()=>{for(;h.length>0&&g<y;){const l=h.shift();g+=1,l().finally(()=>{g-=1,T()})}};for(let l of a){if(l=l.trim(),l.length!==66&&l.length!==64){F.error({message:"错误",description:"请输入正确的stark地址(64位)",duration:1});continue}l.startsWith("0x")||(l="0x"+l);const v=()=>new Promise(async(E,O)=>{try{n(I=>{const C=[...I];if(C.findIndex(b=>b.address===l)===-1){const b={key:D.toString(),address:l,result:"pending"};D++,C.push(b)}return C});const j=await H(l);n(I=>{const C=[...I],p=C.findIndex(b=>b.address===l);return p!==-1&&(C[p]={...C[p],...j}),C}),E()}catch(j){O(j)}});h.push(v)}for(T();g>0||h.length>0;)await new Promise(l=>setTimeout(l,100));F.success({message:"成功",description:"批量添加完成",duration:1})}catch(e){F.error({message:"错误",description:e.message,duration:1})}finally{o.resetFields(),u([]),i(!1)}},R=async e=>{const a=e?[e]:_;if(!a.length){F.error({message:"错误",description:"请先选择要刷新的地址",duration:1});return}f(!0);try{let g=0,h=[];const T=()=>{for(;h.length>0&&g<5;){const l=h.shift();g+=1,l().finally(()=>{g-=1,T()})}};for(let l of a){const v=t.findIndex(E=>E.key===l);if(v!==-1){const E=()=>new Promise(async(O,j)=>{try{n(C=>{const p=[...C];for(let b in p[v])b!=="address"&&b!=="name"&&b!=="key"&&(b==="result"?p[v][b]="pending":p[v][b]=null);return p});const I=await H(t[v].address);n(C=>{const p=[...C];return p[v]={...p[v],...I},localStorage.setItem("stark_addresses",JSON.stringify(p)),p}),O()}catch(I){j(I)}});h.push(E)}}for(T();g>0||h.length>0;)await new Promise(l=>setTimeout(l,100));F.success({message:"完成",description:"刷新地址数据完成",duration:1})}catch(y){F.error({message:"错误",description:y.message,duration:1})}finally{f(!1),e||u([])}},Y=()=>{if(!_.length){F.error({message:"错误",description:"请先选择要删除的地址",duration:1});return}n(t.filter(e=>!_.includes(e.key))),localStorage.setItem("stark_addresses",JSON.stringify(t.filter(e=>!_.includes(e.key)))),u([])},X=()=>{le(t,"starkInfo")},[Z,$]=k.useState(null),ee={selectedRowKeys:_,onChange:e=>{u(e)}};return r.jsx("div",{children:r.jsxs(je,{children:[r.jsx(ie,{title:"批量添加地址",open:d,onOk:K,onCancel:()=>{s(!1),o.resetFields()},okText:"添加地址",cancelText:"取消",width:800,children:r.jsx(q,{form:o,layout:"vertical",children:r.jsx(q.Item,{label:"地址",name:"addresses",rules:[{required:!0,validator:(e,a)=>{const y=a.split(`
`);let g=[];for(let h=0;h<y.length;h++){let T=y[h].trim();(!T.startsWith("0x")||T.length!==66&&T.length!==64)&&g.push(h+1)}return g.length?Promise.reject(`行 ${g.join(", ")} 的地址格式错误，请输入正确的stark地址(64位)`):Promise.resolve()}}],children:r.jsx(Ee,{placeholder:"请输入地址，每行一个",style:{width:"100%",height:"300px",resize:"none"}})})})}),r.jsx("div",{style:{marginBottom:"50px"},children:r.jsx(z,{spinning:x,size:"large",children:r.jsx(oe,{rowSelection:ee,dataSource:t,pagination:!1,bordered:!0,style:{marginBottom:"20px"},size:"small",columns:B})})}),r.jsx("div",{className:"stark_footer",children:r.jsx(te,{size:"small",style:{width:"100%"},children:r.jsxs("div",{style:{width:"100%",display:"flex",justifyContent:"space-between"},children:[r.jsx(S,{type:"primary",onClick:()=>{s(!0)},size:"large",style:{width:"25%"},icon:r.jsx(ce,{}),loading:c,children:c?"添加中...":"添加地址"}),r.jsx(S,{type:"primary",onClick:()=>R(),loading:m,size:"large",style:{width:"25%"},icon:r.jsx(U,{}),children:"刷新选中地址"}),r.jsx(V,{title:"确认删除"+_.length+"个地址？",onConfirm:Y,children:r.jsx(S,{type:"primary",danger:!0,size:"large",style:{width:"25%"},icon:r.jsx(W,{}),children:"删除选中地址"})}),r.jsx(S,{type:"primary",icon:r.jsx(de,{}),size:"large",style:{width:"8%"},onClick:X})]})})})]})})};export{Re as default};
